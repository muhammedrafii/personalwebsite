    ...
    <Card className="w-full max-w-lg rounded-2xl border shadow-lg shadow-primary/10">
      ...
      <CardHeader className="p-6">
        <motion.div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <div className="flex items-center gap-1 text-[10px] sm:text-xs md:text-sm lg:text-base text-muted-foreground whitespace-nowrap">
          ...
          {milestones.map((m, i) => (
            ...
            >
              ...
              <div className="flex flex-col">
                <p className="text-[10px] sm:text-xs md:text-sm lg:text-base font-medium text-foreground">
                  {m.title}
                </p>
                <p className="text-[9px] sm:text-[10px] md:text-sm lg:text-base text-muted-foreground">
                  {m.description}
                </p>
              </div>
            </motion.div>
      ...
      <motion.div className="bg-muted/40 p-6">
        <Button
          onClick={onNextStep}
          size="lg"
          className="w-full text-[10px] sm:text-xs md:text-sm lg:text-base"
        >
          Next Step
        </Button>
      </motion.div>

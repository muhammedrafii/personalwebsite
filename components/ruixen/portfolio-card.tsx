...
}: PortfolioCardProps = defaultProfile) {
  return (
    <div className="relative w-full max-w-sm min-w-[280px] mx-auto rounded-2xl overflow-hidden border border-zinc-200 dark:border-zinc-800 bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md shadow-lg transition-shadow duration-300">
      {/* Banner */}
      <div className="relative h-28 bg-gradient-to-br from-indigo-600 to-purple-700 text-white flex items-end justify-start p-4"></div>
